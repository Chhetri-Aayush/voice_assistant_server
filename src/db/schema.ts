...
export const timeSlotRelations = relations(timeSlots, ({ one }) => ({
  ...
  appointment: one(appointments, {
    fields: [timeSlots.id],
    references: [appointments.timeSlotId],
  }),
}));
...
export const cancellationRelations = relations(cancellations, ({ one }) => ({
  appointment: one(appointments, {
    fields: [cancellations.appointmentId],
    references: [appointments.id],
  }),
  cancelledByUser: one(user, {
    fields: [cancellations.cancelledBy],
    references: [user.id],
  }),
}));
